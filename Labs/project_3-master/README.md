...
Below is the recording from a previous cohort Breakfast Hour which will teach you how to use the API to create a PyScript and fully automate the collection process for posts, allowing you to passively collect as many posts as you need by running the script in Bash/CMD. The section to focus on is from **7:54** to **55:45**.
